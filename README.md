...
#### III. Online Multiplayer: *Backend - Event-Driven Architecture, Microservices*
  ...
  3. Refactor to use **GraphQL Subscriptions** with **AWS AppSync** instead, and implement *time attack* mode, where the players don't take turns, but compete to fill as many squares as quickly as possible. Avoid race conditions (heh).
